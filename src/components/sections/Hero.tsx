...
//   return (
//     <section
//       className='bg-[#141423] relative overflow-hidden py-32 sm:py-20'
//       id='home'
//     >
//       <div className='container mx-auto px-4 -mb-52 sm:mb-0'>
//         {/* Background lines */}
//         <div className='absolute top-0 left-0 w-full sm:min-h-[850px] lg:min-h-[800px] max-h-[1200px] object-cover object-right pointer-events-none'>
//           <Image
...
//             <div className='w-full flex flex-col gap-10 z-10 mb-0 lg:mb-0'>
//               <div className='text-center lg:text-left'>
//                 <h1 className='text-white text-4xl lg:text-5xl xl:text-6xl font-bold mb-8 font-sans'>
//                   <div className='block'>Create The</div>
//                   <div className='block mt-3'>Constructions</div>
//                   <div className='block mt-3'>You Want Here</div>
//                 </h1>

//                 <p className='text-gray-400 mb-10 font-sans lg:px-0 px-0 md:px-40'>
//                   We provide the best home design, construction and maintenance
//                   services for you and your family Lorem ipsum dolor sit amet
//                   consectetur adipisicing elit. Voluptatem, voluptatum..
//                 </p>

//                 <div className='flex flex-wrap justify-center lg:justify-start gap-8 font-sans'>
//                   <Link
//                     href='/services'
...
//                   <Link
//                     href='/projects'
//                     className='inline-flex items-center text-orange-500 font-semibold group'
//                   >
...
//               <div className='flex justify-center lg:justify-start gap-16 lg:gap-18 mb-6 font-sans'>
//                 <div>
//                   <h3 className='text-yellow-400 text-6xl font-bold mb-2'>
//                     10+
//                   </h3>
...
//             <div className='w-full relative z-0 px-4 sm:px-0'>
//               {/* Fixed-position image container */}
//               <div
//                 className='relative w-full mx-auto xl:ml-20'
//                 style={{ maxWidth: '500px', minHeight: '450px' }}
//               >
//                 {/* Main construction worker image */}
//                 <div className='relative z-0 w-5/6 sm:w-full ml-auto'>
//                   <Image
...
//                 {/* Second image - always positioned below and overlapping */}
//                 <div className='absolute -left-5 sm:-left-16 bottom-40 sm:-bottom-16 w-3/4 sm:w-2/3 border-8 border-[#141423] z-10'>
//                   <Image
          ...
          <div className='w-1/2 flex flex-col justify-between z-10 pt-[15vh] pb-[5vh] min-h-[70vh]'>
            <div className='text-left'>
              ...
              <div className='flex flex-wrap justify-start gap-8 md:gap-12 font-sans'>
                <Link
                  href='/services'
                  className='inline-flex bg-gradient-to-r from-orange-500 to-orange-400 text-white font-semibold px-6 py-3 md:px-8 md:py-4 hover:shadow-lg hover:shadow-orange-500/30 transition-all duration-300'
                >
                  Our Services
                </Link>
